...
### plot ###
    ...
    parser_plot_scatterplot.add_argument('--savefig', action='store_true', help="option of saving figure to output or not")
    ...
    parser_plot_corr_heatmap.add_argument('--savefig', action='store_true', help="option of saving figure to output or not")
    ...
    parser_plot_corr_scatterplot.add_argument('--savefig', action='store_true', help="option of saving figure to output or not")
    ...
    parser_plot_boxes.add_argument('--savefig', action='store_true', help="option of saving figure to output or not")
