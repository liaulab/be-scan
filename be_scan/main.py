...
### plot ###
    ...
    parser_plot_scatterplot.add_argument('comparisons', nargs='+', type=str)
    # optional variables
    parser_plot_scatterplot.add_argument('--filter_val', type=bool, default=signat_ps.parameters['filter_val'].default)
    ...
    parser_plot_scatterplot.add_argument('--filter_params', type=bool, default=signat_ps.parameters['filter_params'].default)
    ...
    parser_plot_scatterplot.add_argument('--include_hue', type=bool, default=signat_ps.parameters['include_hue'].default)
    ...
    parser_plot_boxes.add_argument('comparisons', nargs='+', type=str)
    parser_plot_boxes.add_argument('plot_column', type=str)
    parser_plot_boxes.add_argument('plot_conditions', nargs='+', type=str)
    # optional variables
    parser_plot_boxes.add_argument('--filter_val', type=bool, default=signat_pb.parameters['filter_val'].default)
    ...
    parser_plot_boxes.add_argument('--filter_params', type=bool, default=signat_pb.parameters['filter_params'].default)
    ...
    parser_plot_corr_heatmap.add_argument('comparisons', nargs='+', type=str)
    # optional args
    parser_plot_corr_heatmap.add_argument('--corr_type', type=str, default=signat_pch.parameters['corr_type'].default)
    parser_plot_corr_heatmap.add_argument('--filter_val', type=bool, default=signat_pch.parameters['filter_val'].default)
    ...
    parser_plot_corr_heatmap.add_argument('--filter_params', type=bool, default=signat_pch.parameters['filter_params'].default)
    ...
    # optional args
    parser_plot_corr_scatterplot.add_argument('--filter_val', type=bool, default=signat_pcs.parameters['filter_val'].default)
    ...
    parser_plot_corr_scatterplot.add_argument('--filter_params', type=bool, default=signat_pcs.parameters['filter_params'].default)
    ...
    parser_plot_corr_scatterplot.add_argument('--include_hue', type=bool, default=signat_pcs.parameters['include_hue'].default)
