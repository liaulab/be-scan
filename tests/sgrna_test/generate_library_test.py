...
{Description: suit of unit tests for generate_library}
"""
...
def test_generate_library_basic_required_pos(edit_from, edit_to, cas_type):
...
def test_generate_library_cas_neg(): 
    # invalid cas_type
...
def test_generate_library_window_neg(): 
    # negative window
    with pytest.raises(AssertionError): 
        df = generate_library(**AR_params, **CT_Sp_params, 
...
def test_generate_library_edit_neg(): 
    # edit is not ACGT
    with pytest.raises(AssertionError): 
        df = generate_library(**AR_params,
...
def test_generate_library_pam_neg(): 
...
def test_generate_library_excludeintrons_pos(): 
...
def test_generate_library_excludenontargeting_neg(): 
...
def test_generate_library_domains_neg(): 
