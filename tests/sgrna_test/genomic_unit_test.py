...
def test_protein_to_AAseq_pos(): # positive control test
    protein_seq = protein_to_AAseq(filename='tests/test_data/sgrna/P10275.fasta')
    assert len(protein_seq) == 921

def test_protein_to_AAseq_neg(): # negative control test
    protein_seq = protein_to_AAseq(filename='tests/test_data/sgrna/P10275_changed.fasta')
