...
#     os.system("python3 be_scan/analysis/library_qc.py -f tests/test_data/CL-XYH-CBE478-2_S218_L001_R1_001.fastq.gz -i tests/test_data/library_data/230228_AR_CBE_exon8.csv -o AR_CBE")
...
#     os.system("python3 be_scan/analysis/library_qc.py -f tests/test_data/CL-XYH-ABE479-1_S215_L001_R1_001.fastq.gz -i tests/test_data/library_data/230228_AR_ABE_full.csv -o AR_ABE")
...
#     os.system("python3 be_scan/analysis/library_qc.py -f tests/test_data/CL-XYH-ABE479-2_S217_L001_R1_001.fastq.gz -i tests/test_data/library_data/230228_AR_ABE_full.csv -o AR_ABE2")
