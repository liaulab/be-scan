...
def test_plot_corr_scatterplot_basic_pos():
    bsplot.plot_corr_scatterplot(**corr_params, )
    check_comparisons()
...
def test_plot_corr_scatterplot_filtervals_pos():
    bsplot.plot_corr_scatterplot(**corr_params, filter_val=True, 
                                 val_min=0.0, val_cols=["d3-pos", "d6-pos", "d9-pos"], )
    check_comparisons()

def test_plot_corr_scatterplot_filterparams_pos():
    bsplot.plot_corr_scatterplot(**corr_params, filter_params=True, 
...
def test_plot_corr_scatterplot_hue_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_corr_scatterplot(**corr_params, include_hue=True, **params )
        check_comparisons()
...
def test_plot_corr_scatterplot_filtervals_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_corr_scatterplot(**corr_params, filter_val=True, **params )
        check_comparisons()
...
def test_plot_corr_scatterplot_filterparams_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_corr_scatterplot(**corr_params, filter_params=True, **params )
        check_comparisons()
