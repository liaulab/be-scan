...
def test_plot_scatterplot_basic_pos():
    bsplot.plot_scatterplot(df_filepath = file, x_column = 'Edit_site_3A1', comparisons = comparisons, 
    )
    check_comparisons()
...
def test_plot_scatterplot_autoannot1_pos():
    bsplot.plot_scatterplot(df_filepath = file, x_column = 'Edit_site_3A1', comparisons = comparisons, 
                            autoannot=True, autoannot_label='sgRNA_ID', autoannot_top=10,
    )
    check_comparisons()

def test_plot_scatterplot_autoannot2_pos():
    bsplot.plot_scatterplot(df_filepath = file, x_column = 'Edit_site_3A1', comparisons = comparisons, 
                            autoannot=True, autoannot_label='sgRNA_ID', autoannot_cutoff=2.0,
    )
    check_comparisons()
