...
def test_plot_scatterplot_basic_pos():
    bsplot.plot_scatterplot(**scatter_params, )
    check_comparisons()

def test_plot_scatterplot_hue_pos():
    bsplot.plot_scatterplot(**scatter_params,
                            include_hue=True, hue_col="Mut_type", )
    check_comparisons()

def test_plot_scatterplot_negctrl_pos():
    bsplot.plot_scatterplot(**scatter_params, neg_ctrl=True, 
                            neg_ctrl_col="Gene", neg_ctrl_conditions=["NON-GENE"], )
    check_comparisons()
        
def test_plot_scatterplot_filtervals_pos():
    bsplot.plot_scatterplot(**scatter_params, filter_val=True, 
                            val_min=0.0, val_cols=["d3-pos", "d6-pos", "d9-pos"], )
    check_comparisons()

def test_plot_scatterplot_filterparams_pos():
    bsplot.plot_scatterplot(**scatter_params, filter_params=True, 
                            params_cols=["sgRNA_strand"], params_conditions=[["sense"]], )
    check_comparisons()

def test_plot_scatterplot_autoannot1_pos():
    bsplot.plot_scatterplot(**scatter_params, autoannot=True, 
                            autoannot_label="sgRNA_ID", autoannot_top=10, )
    check_comparisons()

def test_plot_scatterplot_autoannot2_pos():
    bsplot.plot_scatterplot(**scatter_params, autoannot=True, 
...
def test_plot_scatterplot_hue_neg(params):
...
def test_plot_scatterplot_negctrl_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_scatterplot(**scatter_params, neg_ctrl=True, **params )
        check_comparisons()
...
def test_plot_scatterplot_filtervals_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_scatterplot(**scatter_params, filter_val=True, **params )
        check_comparisons()
...
def test_plot_scatterplot_filterparams_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_scatterplot(**scatter_params, filter_params=True, **params )
        check_comparisons()
...
def test_plot_scatterplot_autoannot1_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_scatterplot(**scatter_params, autoannot=True, **params )
        check_comparisons()
...
def test_plot_scatterplot_autoannot2_neg(params):
    with pytest.raises(AssertionError): 
        bsplot.plot_scatterplot(**scatter_params, autoannot=True, **params )
        check_comparisons()
